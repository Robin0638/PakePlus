...
const QuickNavManager = {
    ...
    createQuickNav() {
        ...
        if (!recentTasksSection) {
            console.error('找不到Soon视图，Empty法创建快速导航');
            return;
        }
...
// 监听UIManager的视图切换Things，更新快速导航状态
document.addEventListener('DOMContentLoaded', () => {
    // 监听视图切换，更新快速导航状态
