...
const CountdownManager = {
    ...
    _formatCountdownText(countdown) {
        ...
        content += `类型: ${countdown.type === 'yearly' ? '每年重复' : '单次'}\n`;
...
`;
        ...
        <div class="countdown-card" style="--accent-color: ${countdown.color}">
            ...
            <div class="countdown-date">
                ${this.formatDate(countdown.date)}
                <span class="countdown-type">${countdown.type === 'yearly' ? '每年重复' : '单次'}</span>
            </div>
...
`;
    ...
    generateCsvExport(countdowns) {
        ...
        countdowns.forEach(countdown => {
            ...
            // 格式化类型
            const type = countdown.type === 'yearly' ? '每年重复' : '单次';
