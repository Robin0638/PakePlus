...
class FocusRelaxInteractionManager {
    ...
    init() {
        ...
        console.log('初始化Focus与Downtime交互管理器');
    ...
    cacheElements() {
        ...
        console.log('缓存了', this.relaxButtons.length, '个Downtime按钮');
        console.log('缓存了', this.relaxViews.length, '个Downtime视图');
    }
    ...
    disableRelaxButtons() {
        this.relaxButtons.forEach(button => {
            if (button) {
                ...
                button.title = '专注进行medium，请先Completed专注';
    ...
    addFocusStatusIndicator(button) {
        ...
        indicator.setAttribute('aria-label', 'Focus激活medium');
    ...
    showFocusActiveNotification() {
        ...
        notification.innerHTML = `
            <div class="notification-content">
                ...
                <span>专注进行medium，请先Completed专注</span>
            </div>
        `;
